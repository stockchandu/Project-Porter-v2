let parent = document.getElementById("dropofdata")
function pickup() {
    let input = document.getElementById("drop_off").value
...
function showdata(result) {
    ...
    if (document.getElementById("drop_off").value === "") {
        document.getElementById("dropofdata").style.display = "none"
    }
...
function getinput(data) {
    data.onclick = function () {
        document.getElementById("drop_off").value = data.innerHTML
        document.getElementById("dropofdata").style.display = "none"
    }
